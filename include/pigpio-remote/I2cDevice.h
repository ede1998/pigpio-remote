...
namespace pigpio_remote
{
    ...
    */
    ...
    public:
         ...
         * @param register register to write in
         * @param data data byte to write
         * @return I2cWriteError
         */
        I2cWriteError WriteByteData(uint8_t register, uint8_t data);
         ...
         * @return PigpioResult<uint8_t, I2cReadError> read data byte or error code
         */
        PigpioResult<uint8_t, I2cReadError> ReadByteData(uint8_t register);
         ...
         * @return I2cWriteError
         */
        I2cWriteError WriteWordData(uint8_t register, uint16_t data);
         ...
         */
        PigpioResult<uint16_t, I2cReadError> ReadWordData(uint8_t register);
         ...
         * @param register register to write the data in
         * @return PigpioResult<uint16_t, I2cReadError> read data word or error code
         */
        PigpioResult<uint16_t, I2cReadError> ProcessCall(uint8_t register, uint16_t data_word);
         ...
         * @return I2cWriteError
         */
        I2cWriteError WriteBlockData(uint8_t register, const std::vector<uint8_t> &data);
         ...
         */
        PigpioResult<std::vector<uint8_t>, I2cReadError> ReadBlockData(uint8_t register);

        /**
         * @brief This writes data bytes to the specified register of the device and reads a device specified number of bytes of data in return.
         *
         ...
         */
        PigpioResult<std::vector<uint8_t>, I2cReadError> BlockProcessCall(uint8_t register, const std::vector<uint8_t> &data);
         ...
         * @return I2cWriteError
         */
        I2cWriteError WriteI2cBlockData(uint8_t register, const std::vector<uint8_t> &data);
         ...
         * @return PigpioResult<std::vector<uint8_t>, I2cReadError> received data or error code
         */
        PigpioResult<std::vector<uint8_t>, I2cReadError> ReadI2cBlockData(uint8_t register, uint8_t count);

        /**
         * @brief This writes count bytes from \p data to the raw device.
         *
