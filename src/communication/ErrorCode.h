#ifndef PIGPIO_REMOTE_SRC_COMMUNICATION_ERRORCODE_H
#define PIGPIO_REMOTE_SRC_COMMUNICATION_ERRORCODE_H
...
namespace pigpio_remote
{
    ...
    namespace communication
    {
        ...
        /**
         * @brief All possible error codes that the library might return.
         * 
         * This enum is a Frankenstein's monster of possible error codes from the original Pigpio library.
         * All the error codes are put inside here.
         * 
         * Positive error codes are additions that are unique to the pigpio_remote library.
         * 
         * This enum isn't intended for direct interaction. Methods always return a class of
         * parent type `BasicPigpioErrorView`. This class takes an arbitrary number of template arguments.
         * Those describe a subset of this enum here and narrow down, which errors a method might return.
         * 
         */
        enum class PigpioError
        {
            PI_UNEXPECTED_ERROR = 1000,             ///< an error occurred that is not valid for called method
            PI_I2C_CONNECTION_OPENED_ALREADY = 999, ///< connection to the I2C has already been opened
            pigif_bad_send = -2000,                 ///< Error while trying to send data
            pigif_bad_recv = -2001,                 ///< Error while trying to receive data
            pigif_bad_getaddrinfo = -2002,          ///< Unused
            pigif_bad_connect = -2003,              ///< Unused
            pigif_bad_socket = -2004,               ///< Unused
            pigif_bad_noib = -2005,                 ///< Unused
            pigif_duplicate_callback = -2006,       ///< Unused
            pigif_bad_malloc = -2007,               ///< Unused
            pigif_bad_callback = -2008,             ///< Unused
            pigif_notify_failed = -2009,            ///< Unused
            pigif_callback_not_found = -2010,       ///< Unused
            pigif_unconnected_pi = -2011,           ///< Returned if any method other than `PiConnection::Connect()` or `PiConnection::Stop()` is called while no connection is opened.
            pigif_too_many_pis = -2012,             ///< Unused
